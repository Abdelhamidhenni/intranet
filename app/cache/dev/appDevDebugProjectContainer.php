...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig'), $this->get('monolog.logger.assetic', ContainerInterface::NULL_ON_INVALID_REFERENCE)), new \Assetic\Cache\ConfigCache('/var/www/html/intranet/app/cache/dev/assetic/config'), true)));
    ...
    {
        return $this->services['ccdn_forum_forum.component.helper.role'] = new \CCDNForum\ForumBundle\Component\Helper\RoleHelper($this->get('security.context'), array('ROLE_ADMIN' => array(0 => 'ROLE_USER'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_USER', 1 => 'ROLE_ADMIN', 2 => 'ROLE_ALLOWED_TO_SWITCH')));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $c->addResolveTargetEntity('Symfony\\Component\\Security\\Core\\User\\UserInterface', 'Futur\\UserBundle\\Entity\\User', array());
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'salutcava', 'user' => 'root', 'password' => 'superfur', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $d, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => '/var/www/html/intranet/src/Futur/TicketBundle/Entity', 1 => '/var/www/html/intranet/src/Futur/ModuleBundle/Entity', 2 => '/var/www/html/intranet/src/Futur/SujetBundle/Entity', 3 => '/var/www/html/intranet/src/Futur/PlanningBundle/Entity', 4 => '/var/www/html/intranet/src/Futur/NoteBundle/Entity', 5 => '/var/www/html/intranet/src/Futur/CoursBundle/Entity', 6 => '/var/www/html/intranet/src/Futur/UserBundle/Entity'));

        $c = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array('/var/www/html/intranet/vendor/codeconsortium/ccdn-forum-bundle/CCDNForum/ForumBundle/Resources/config/doctrine' => 'CCDNForum\\ForumBundle\\Entity'));
        $c->setGlobalBasename('mapping');

        $d = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $d->addDriver($b, 'Futur\\TicketBundle\\Entity');
        $d->addDriver($b, 'Futur\\ModuleBundle\\Entity');
        $d->addDriver($b, 'Futur\\SujetBundle\\Entity');
        $d->addDriver($b, 'Futur\\PlanningBundle\\Entity');
        $d->addDriver($b, 'Futur\\NoteBundle\\Entity');
        $d->addDriver($b, 'Futur\\CoursBundle\\Entity');
        $d->addDriver($b, 'Futur\\UserBundle\\Entity');
        $d->addDriver($c, 'CCDNForum\\ForumBundle\\Entity');
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\XmlDriver(new \Doctrine\Common\Persistence\Mapping\Driver\SymfonyFileLocator(array('/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/config/doctrine/model' => 'FOS\\UserBundle\\Model'), '.orm.xml')), 'FOS\\UserBundle\\Model');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('FuturTicketBundle' => 'Futur\\TicketBundle\\Entity', 'FuturModuleBundle' => 'Futur\\ModuleBundle\\Entity', 'FuturSujetBundle' => 'Futur\\SujetBundle\\Entity', 'FuturPlanningBundle' => 'Futur\\PlanningBundle\\Entity', 'FuturNoteBundle' => 'Futur\\NoteBundle\\Entity', 'FuturCoursBundle' => 'Futur\\CoursBundle\\Entity', 'FuturUserBundle' => 'Futur\\UserBundle\\Entity', 'CCDNForumForumBundle' => 'CCDNForum\\ForumBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_e27611b6a20932bea94486099156b1ee701c0ba2e312e21354bd94ea66b97e3d');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Futur\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Futur\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Futur\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Futur\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Futur\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/var/www/html/intranet/app/logs/dev.log', 100, true, NULL);
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Futur\\UserBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 5000)), 'Symfony\\Component\\Security\\Core\\User\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\PlaintextPasswordEncoder', 'arguments' => array(0 => false)), 'FOS\\UserBundle\\Model\\UserInterface' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 5000))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $h = new \Symfony\Component\HttpFoundation\RequestMatcher('^/ticket');

        $i = new \Symfony\Component\HttpFoundation\RequestMatcher('^/modules');

        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin');

        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/planning');

        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/annuaire');

        $m = new \Symfony\Component\HttpFoundation\RequestMatcher('^/profile');

        $n = new \Symfony\Component\HttpFoundation\RequestMatcher('^/forumName');
        ...
        $q = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $b), 'ThisTokenIsNotSoSecretChangeIt', 'main', array('name' => 'REMEMBERME', 'lifetime' => 31536000, 'path' => '/', 'domain' => NULL, 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $a);

        $r = new \Symfony\Component\Security\Http\Firewall\LogoutListener($c, $p, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($p, '/fr'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => 'fos_user_security_logout'));
        $r->addHandler(new \Symfony\Component\Security\Http\Logout\SessionLogoutHandler());
        $r->addHandler($q);

        $s = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($p, array('always_use_default_target_path' => true, 'default_target_path' => '/fr', 'login_path' => 'fos_user_security_login', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $s->setProviderKey('main');

        $t = new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($c, $g, $this->get('security.authentication.session_strategy'), $p, 'main', $s, new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($f, $p, array('login_path' => 'fos_user_security_login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $a), array('check_path' => 'fos_user_security_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $d, $this->get('form.csrf_provider'));
        $t->setRememberMeServices($q);

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($o, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($c, array(0 => new \Symfony\Component\Security\Core\User\ChainUserProvider(array(0 => $b)), 1 => new \FOS\UserBundle\Security\UserProvider($b), 2 => $b), 'main', $a, $d), 2 => $r, 3 => $t, 4 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($c, $q, $g, $a, $d), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($c, '54c2b7237a486', $a), 6 => new \Symfony\Component\Security\Http\Firewall\AccessListener($c, $this->get('security.access.decision_manager'), $o, $g)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($c, $this->get('security.authentication.trust_resolver'), $p, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $p, 'fos_user_security_login', false), NULL, NULL, $a));
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/var/www/html/intranet/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => '/var/www/html/intranet/app/cache/dev/translations', 'debug' => true));
        ...
        $instance->addResource('xlf', '/var/www/html/intranet/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.vi.xlf', 'vi', 'validators');
        ...
        $instance->addResource('xlf', '/var/www/html/intranet/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.th.xlf', 'th', 'validators');
        ...
        $instance->addResource('xlf', '/var/www/html/intranet/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.zh_TW.xlf', 'zh_TW', 'validators');
        ...
        $instance->addResource('xlf', '/var/www/html/intranet/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.uk.xlf', 'uk', 'validators');
        ...
        $instance->addResource('yml', '/var/www/html/intranet/src/Futur/SiteBundle/Resources/translations/messages.en.yml', 'en', 'messages');
        $instance->addResource('xlf', '/var/www/html/intranet/src/Futur/TicketBundle/Resources/translations/messages.fr.xlf', 'fr', 'messages');
        $instance->addResource('yml', '/var/www/html/intranet/src/Futur/UserBundle/Resources/translations/messages.en.yml', 'en', 'messages');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.it.yml', 'it', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.fa.yml', 'fa', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.en.yml', 'en', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ro.yml', 'ro', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.pl.yml', 'pl', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ja.yml', 'ja', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.lv.yml', 'lv', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.he.yml', 'he', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ru.yml', 'ru', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.id.yml', 'id', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.he.yml', 'he', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.fi.yml', 'fi', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ca.yml', 'ca', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ar.yml', 'ar', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.cs.yml', 'cs', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.th.yml', 'th', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.uk.yml', 'uk', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.nl.yml', 'nl', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.lt.yml', 'lt', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.zh_CN.yml', 'zh_CN', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.sr_Latn.yml', 'sr_Latn', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.vi.yml', 'vi', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.sl.yml', 'sl', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.uk.yml', 'uk', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.pt.yml', 'pt', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.hr.yml', 'hr', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.eu.yml', 'eu', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.fa.yml', 'fa', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ro.yml', 'ro', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.de.yml', 'de', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.lb.yml', 'lb', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.da.yml', 'da', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.lt.yml', 'lt', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.pt.yml', 'pt', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.fi.yml', 'fi', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.nb.yml', 'nb', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.sk.yml', 'sk', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.lv.yml', 'lv', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.th.yml', 'th', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.es.yml', 'es', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.da.yml', 'da', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.el.yml', 'el', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.bg.yml', 'bg', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.zh_CN.yml', 'zh_CN', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.vi.yml', 'vi', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ru.yml', 'ru', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.tr.yml', 'tr', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.it.yml', 'it', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ar.yml', 'ar', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.tr.yml', 'tr', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.pl.yml', 'pl', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.cs.yml', 'cs', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.de.yml', 'de', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.es.yml', 'es', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.sl.yml', 'sl', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.fr.yml', 'fr', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.eu.yml', 'eu', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.pt_BR.yml', 'pt_BR', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.sk.yml', 'sk', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.bg.yml', 'bg', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.pt_BR.yml', 'pt_BR', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.hu.yml', 'hu', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.nl.yml', 'nl', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.id.yml', 'id', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.en.yml', 'en', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.hr.yml', 'hr', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.sv.yml', 'sv', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.fr.yml', 'fr', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.sv.yml', 'sv', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.el.yml', 'el', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ca.yml', 'ca', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.hu.yml', 'hu', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.sr_Latn.yml', 'sr_Latn', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.et.yml', 'et', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ja.yml', 'ja', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.nb.yml', 'nb', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/validators.it.yml', 'it', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/validators.fa.yml', 'fa', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/validators.en.yml', 'en', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/validators.ro.yml', 'ro', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/validators.pl.yml', 'pl', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/FOSUserBundle.ja.yml', 'ja', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/validators.lv.yml', 'lv', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/FOSUserBundle.he.yml', 'he', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/FOSUserBundle.ru.yml', 'ru', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/validators.id.yml', 'id', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/validators.he.yml', 'he', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/validators.fi.yml', 'fi', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/FOSUserBundle.ca.yml', 'ca', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/FOSUserBundle.ar.yml', 'ar', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/validators.cs.yml', 'cs', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/validators.th.yml', 'th', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/validators.uk.yml', 'uk', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/FOSUserBundle.nl.yml', 'nl', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/validators.lt.yml', 'lt', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/validators.zh_CN.yml', 'zh_CN', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/validators.sr_Latn.yml', 'sr_Latn', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/validators.vi.yml', 'vi', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/validators.sl.yml', 'sl', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/FOSUserBundle.uk.yml', 'uk', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/FOSUserBundle.hr.yml', 'hr', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/FOSUserBundle.fa.yml', 'fa', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/FOSUserBundle.ro.yml', 'ro', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/validators.de.yml', 'de', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/FOSUserBundle.lb.yml', 'lb', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/validators.da.yml', 'da', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/FOSUserBundle.lt.yml', 'lt', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/validators.pt.yml', 'pt', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/FOSUserBundle.fi.yml', 'fi', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/validators.nb.yml', 'nb', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/validators.sk.yml', 'sk', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/FOSUserBundle.lv.yml', 'lv', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/FOSUserBundle.th.yml', 'th', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/FOSUserBundle.es.yml', 'es', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/FOSUserBundle.da.yml', 'da', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/FOSUserBundle.bg.yml', 'bg', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/FOSUserBundle.zh_CN.yml', 'zh_CN', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/FOSUserBundle.vi.yml', 'vi', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/validators.ru.yml', 'ru', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/validators.tr.yml', 'tr', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/FOSUserBundle.it.yml', 'it', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/validators.ar.yml', 'ar', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/FOSUserBundle.tr.yml', 'tr', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/FOSUserBundle.pl.yml', 'pl', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/FOSUserBundle.cs.yml', 'cs', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/FOSUserBundle.de.yml', 'de', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/validators.es.yml', 'es', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/FOSUserBundle.sl.yml', 'sl', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/validators.fr.yml', 'fr', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/validators.pt_BR.yml', 'pt_BR', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/FOSUserBundle.sk.yml', 'sk', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/validators.bg.yml', 'bg', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/FOSUserBundle.pt_BR.yml', 'pt_BR', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/validators.hu.yml', 'hu', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/validators.nl.yml', 'nl', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/FOSUserBundle.id.yml', 'id', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/FOSUserBundle.en.yml', 'en', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/validators.hr.yml', 'hr', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/validators.sv.yml', 'sv', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/FOSUserBundle.fr.yml', 'fr', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/FOSUserBundle.sv.yml', 'sv', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/validators.ca.yml', 'ca', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/FOSUserBundle.hu.yml', 'hu', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/FOSUserBundle.sr_Latn.yml', 'sr_Latn', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/FOSUserBundle.et.yml', 'et', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/validators.ja.yml', 'ja', 'validators');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/FOSUserBundle.nb.yml', 'nb', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/FOSUserBundle/translations/FOSUserBundle.pt_PT.yml', 'pt_PT', 'FOSUserBundle');
        $instance->addResource('xlf', '/var/www/html/intranet/src/Futur/AdminBundle/Resources/translations/messages.fr.xlf', 'fr', 'messages');
        $instance->addResource('xlf', '/var/www/html/intranet/src/Futur/ModuleBundle/Resources/translations/messages.fr.xlf', 'fr', 'messages');
        $instance->addResource('xlf', '/var/www/html/intranet/src/Futur/SujetBundle/Resources/translations/messages.fr.xlf', 'fr', 'messages');
        $instance->addResource('yml', '/var/www/html/intranet/src/Futur/PlanningBundle/Resources/translations/messages.en.yml', 'en', 'messages');
        $instance->addResource('yml', '/var/www/html/intranet/src/Futur/PlanningBundle/Resources/translations/messages.fr.yml', 'fr', 'messages');
        $instance->addResource('yml', '/var/www/html/intranet/src/Futur/AnnuaireBundle/Resources/translations/messages.en.yml', 'en', 'messages');
        $instance->addResource('yml', '/var/www/html/intranet/src/Futur/AnnuaireBundle/Resources/translations/messages.fr.yml', 'fr', 'messages');
        $instance->addResource('yml', '/var/www/html/intranet/vendor/codeconsortium/ccdn-forum-bundle/CCDNForum/ForumBundle/Resources/translations/CCDNForumForumBundle.en.yml', 'en', 'CCDNForumForumBundle');
        $instance->addResource('xlf', '/var/www/html/intranet/src/Futur/FofoBundle/Resources/translations/messages.fr.xlf', 'fr', 'messages');
        $instance->addResource('yml', '/var/www/html/intranet/src/Futur/FofoBundle/Resources/translations/CCDNForumForumBundle.fr.yml', 'fr', 'CCDNForumForumBundle');
        $instance->addResource('xlf', '/var/www/html/intranet/src/Futur/CoursBundle/Resources/translations/messages.fr.xlf', 'fr', 'messages');
        $instance->addResource('xlf', '/var/www/html/intranet/src/Futur/NoteBundle/Resources/translations/messages.fr.xlf', 'fr', 'messages');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/translations/FOSUserBundle.en.yml', 'en', 'FOSUserBundle');
        $instance->addResource('yml', '/var/www/html/intranet/app/Resources/translations/FOSUserBundle.fr.yml', 'fr', 'FOSUserBundle');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/var/www/html/intranet/vendor/symfony/swiftmailer-bundle/Resources/views', 'Swiftmailer');
        $instance->addPath('/var/www/html/intranet/vendor/doctrine/doctrine-bundle/Resources/views', 'Doctrine');
        $instance->addPath('/var/www/html/intranet/src/Futur/SiteBundle/Resources/views', 'FuturSite');
        $instance->addPath('/var/www/html/intranet/src/Futur/TicketBundle/Resources/views', 'FuturTicket');
        $instance->addPath('/var/www/html/intranet/src/Futur/UserBundle/Resources/views', 'FuturUser');
        $instance->addPath('/var/www/html/intranet/app/Resources/FOSUserBundle/views', 'FOSUser');
        $instance->addPath('/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/views', 'FOSUser');
        $instance->addPath('/var/www/html/intranet/src/Futur/AdminBundle/Resources/views', 'FuturAdmin');
        $instance->addPath('/var/www/html/intranet/src/Futur/ModuleBundle/Resources/views', 'FuturModule');
        $instance->addPath('/var/www/html/intranet/src/Futur/SujetBundle/Resources/views', 'FuturSujet');
        $instance->addPath('/var/www/html/intranet/src/Futur/PlanningBundle/Resources/views', 'FuturPlanning');
        $instance->addPath('/var/www/html/intranet/src/Futur/AnnuaireBundle/Resources/views', 'FuturAnnuaire');
        $instance->addPath('/var/www/html/intranet/vendor/knplabs/knp-paginator-bundle/Knp/Bundle/PaginatorBundle/Resources/views', 'KnpPaginator');
        $instance->addPath('/var/www/html/intranet/vendor/codeconsortium/ccdn-forum-bundle/CCDNForum/ForumBundle/Resources/views', 'CCDNForumForum');
        $instance->addPath('/var/www/html/intranet/src/Futur/FofoBundle/Resources/views', 'FuturFofo');
        $instance->addPath('/var/www/html/intranet/src/Futur/CoursBundle/Resources/views', 'FuturCours');
        $instance->addPath('/var/www/html/intranet/src/Futur/NoteBundle/Resources/views', 'FuturNote');
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => '/var/www/html/intranet/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml', 1 => '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/config/validation.xml', 2 => '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/config/validation/orm.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array(0 => '/var/www/html/intranet/vendor/codeconsortium/ccdn-forum-bundle/CCDNForum/ForumBundle/Resources/config/validation.yml')))), NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'FuturSiteBundle' => 'Futur\\SiteBundle\\FuturSiteBundle',
                'FuturTicketBundle' => 'Futur\\TicketBundle\\FuturTicketBundle',
                'FuturUserBundle' => 'Futur\\UserBundle\\FuturUserBundle',
                'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle',
                'FuturAdminBundle' => 'Futur\\AdminBundle\\FuturAdminBundle',
                'FuturModuleBundle' => 'Futur\\ModuleBundle\\FuturModuleBundle',
                'FuturSujetBundle' => 'Futur\\SujetBundle\\FuturSujetBundle',
                'FuturPlanningBundle' => 'Futur\\PlanningBundle\\FuturPlanningBundle',
                'FuturAnnuaireBundle' => 'Futur\\AnnuaireBundle\\FuturAnnuaireBundle',
                'KnpPaginatorBundle' => 'Knp\\Bundle\\PaginatorBundle\\KnpPaginatorBundle',
                'CCDNForumForumBundle' => 'CCDNForum\\ForumBundle\\CCDNForumForumBundle',
                'FuturFofoBundle' => 'Futur\\FofoBundle\\FuturFofoBundle',
                'FuturCoursBundle' => 'Futur\\CoursBundle\\FuturCoursBundle',
                'FuturNoteBundle' => 'Futur\\NoteBundle\\FuturNoteBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'salutcava',
            'database_user' => 'root',
            'database_password' => 'superfur',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                ...
                1 => '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/config/validation.xml',
                2 => '/var/www/html/intranet/vendor/friendsofsymfony/user-bundle/Resources/config/validation/orm.xml',
            ),
            'validator.mapping.loader.yaml_files_loader.mapping_files' => array(
                0 => '/var/www/html/intranet/vendor/codeconsortium/ccdn-forum-bundle/CCDNForum/ForumBundle/Resources/config/validation.yml',
            ),
            ...
            'swiftmailer.spool.default.memory.path' => '/var/www/html/intranet/app/cache/dev/swiftmailer/spool/default',
            ...
            'fos_user.model.user.class' => 'Futur\\UserBundle\\Entity\\User',
